...
public board2() {
    ...
    squares[7][1].add(new JLabel(new ImageIcon("knightgreen.png")));
    squares[7][2].add(new JLabel(new ImageIcon("bishopred.png")));
    squares[7][3].add(new JLabel(new ImageIcon("queengreen.png")));
    squares[7][4].add(new JLabel(new ImageIcon("kingred.png")));
    squares[7][5].add(new JLabel(new ImageIcon("bishopred.png")));
    squares[7][6].add(new JLabel(new ImageIcon("knightgreen.png")));
